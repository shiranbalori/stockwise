...
export const MESSAGES = {
  footerDisclaimer:
    'למטרות לימוד בלבד. המידע אינו מהווה ייעוץ השקעות.',

  emptyTicker: 'נא להזין סימול מניה.',
  stockLoadFailed: 'לא ניתן לטעון נתוני מניה כרגע. נסו שוב מאוחר יותר.',
  tickerNotFound: 'לא נמצאו נתונים עבור הסימול הזה',
  networkError: 'בעיית חיבור לרשת. בדקו את החיבור ונסו שוב.',
  rateLimit: 'חרגנו ממגבלת הבקשות לנתוני שוק. נסו שוב בעוד דקה.',
